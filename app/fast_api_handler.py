...
class FastApiHandler:
    ...
    def __init__(self):
        ...
        self.model_path = "/home/mle_projects/mle-sprint3/models/catboost_churn_model.bin"
        ...
        self.required_model_params = [
            ...
            'PaymentMethod', 'MonthlyCharges', 'TotalCharges', 'MultipleLines', 'InternetService',
            'OnlineSecurity', 'OnlineBackup', 'DeviceProtection', 'TechSupport', 'StreamingTV',
            'StreamingMovies', 'days', 'services'
        ]
    ...
    def churn_predict(self, model_params: dict) -> float:
        ...
        # Признаки должны идти в том порядке, в котром были при обучении
        param_values_list = list(model_params.values())
        probability = self.model.predict_proba(param_values_list)[1]
        return probability
    ...
    def check_required_query_params(self, query_params: dict) -> bool:
        ...
        # Проверяем, что типы query_params совпадают с ожидаемыми
